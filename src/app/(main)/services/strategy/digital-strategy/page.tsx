  ...
  return (
    <div className="container py-12 md:py-16">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Navigating the digital landscape with our <span className="font-semibold text-accent">{serviceCategory}</span> expertise.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        <div className="prose prose-lg max-w-none text-muted-foreground">
          ...
          <h3 className="text-xl font-semibold text-primary mt-6 mb-3">Digital Pillars:</h3>
          <ul>
