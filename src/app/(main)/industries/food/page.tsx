...
import { ArrowLeft, Apple, ShieldCheck, Leaf, PackageSearch } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-video overflow-hidden rounded-lg shadow-2xl">
              <Image
                ...
                data-ai-hint="fresh produce market"
              />
            </div>
          </div>
        </section>
...
import { Lightbulb, Settings, LineChart } from "lucide-react";
